...
export const listFolders: ListFolder[] = [{ id: 'folder-family', name: 'Family' }];
...
// --- Tag Folders & Tags ---
export const tagFolders: TagFolder[] = [{ id: 'tag-folder-main', name: 'Main Topics' }];
...
export const tasks: Task[] = [
  {
    ...
    completed: false,
    description:
      'Update with latest project details and tailor for banking, financial services, and insurance sector roles.',
    tags: ['tag-3', 'tag-5'],
    priority: 1,
  },
  {
  ...
  },
  {
    id: '3',
    listId: 'inbox',
    title: 'Discuss with Rahul on Policy',
    completed: true,
    tags: ['tag-3'],
    priority: 1,
  },
  ...
  },
  {
    id: '5',
    listId: 'inbox',
    title: "Stop Doing This - It's Destroying Your Brain Health.",
    completed: false,
    dueDate: today,
    tags: ['tag-4'],
    priority: 4,
  ...
  },
  {
    id: '8',
    listId: 'inbox',
    title: '101 Ways To Use AI In Your Life',
    completed: false,
    dueDate: today,
    tags: ['tag-1'],
    priority: 2,
  ...
  },
  {
    id: '12',
    listId: 'inbox',
    title: 'Prepare a 20 page booklet on 20 courses',
    completed: false,
    dueDate: futureDate,
    tags: ['tag-3'],
  },
