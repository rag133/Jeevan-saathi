                    ...
                    .map((tag) => (
                      <li key={tag.id} className="px-2 pl-8">
                        <button
                          ...
                          className={`w-full text-left flex items-center gap-2 px-2 py-1 text-sm font-medium rounded-md ${selectedItem.type === 'tag' && selectedItem.id === tag.id ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-200'}`}
                        >
