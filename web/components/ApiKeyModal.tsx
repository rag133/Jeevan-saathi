        ...
        <div className="flex items-start gap-4 p-4 bg-blue-50 border-l-4 border-blue-400 rounded-r-lg">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 mt-1">
              Your API key is stored securely in your browser&apos;s local storage and is never sent to
              our servers. It&apos;s used directly from your browser to communicate with the Gemini API
              for features like smart task creation and subtask generation.
            </p>
            <a
