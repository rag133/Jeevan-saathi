...
const DainandiniSidebar: React.FC<DainandiniSidebarProps> = ({ foci, templates, selection, onSelect, onOpenModal, onCreateTemplate, onEditFocus, onReorderFoci }) => {
        ...
        <aside className="w-72 flex-shrink-0 bg-gray-100/80 border-r border-gray-200 p-2 flex flex-col">
            <nav className="flex-1 overflow-y-auto">
                ...
                <ul className="space-y-1 pt-2">
                    <li className="px-2"><SidebarItem id="today" type="today" name="Today's Journal" icon="TodayIcon" isSelected={selection.type === 'today'} onSelect={() => onSelect({ type: 'today' })} /></li>
                    <li className="px-2"><SidebarItem id="calendar" type="calendar" name="Calendar" icon="CalendarIcon" isSelected={selection.type === 'calendar'} onSelect={() => onSelect({ type: 'calendar' })} /></li>
                </ul>
