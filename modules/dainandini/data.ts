...
export const initialFoci: Focus[] = [
  { id: 'general', name: 'General', description: 'For everyday thoughts, notes, and musings.', icon: 'ListIcon', color: 'gray-500', allowedLogTypes: [LogType.TEXT, LogType.CHECKLIST, LogType.RATING] },
  { id: 'kary', name: 'Kary', description: 'Log entries related to tasks and work progress.', icon: 'CheckSquareIcon', color: 'green-500', allowedLogTypes: [LogType.TEXT, LogType.CHECKLIST, LogType.RATING] },
  { id: 'gratitude', name: 'Gratitude', description: 'A space to reflect on what you\'re thankful for.', icon: 'HeartIcon', color: 'pink-500', allowedLogTypes: [LogType.TEXT, LogType.RATING] },
  { id: 'ideas', name: 'Ideas', description: 'Capture fleeting ideas and inspiration.', icon: 'MagicWandIcon', color: 'purple-500', allowedLogTypes: [LogType.TEXT] },
  { id: 'mood', name: 'Mood', icon: 'TagIcon', color: 'yellow-500', allowedLogTypes: [LogType.RATING] },
  { id: 'daily-tasks', name: 'Daily Tasks', icon: 'CheckSquareIcon', color: 'blue-500', allowedLogTypes: [LogType.CHECKLIST] },
];
...
export const initialLogs: Log[] = [
    // --- Task-related logs ---
    {
        ...
        description: 'Began the process of tailoring my resume. This is a crucial step for the next phase of my career.',
    ...
    },
    {
        ...
        description: 'It should be able to analyze mood patterns over time based on text entries using sentiment analysis.',
...
export const initialLogTemplates: LogTemplate[] = [
    ...
    },
    {
        ...
        description: '1. What went well this week?\n2. What didn\'t go so well?\n3. What will I focus on next week?',
    },
    {
        id: 'template-mood',
        name: 'Mood Check-in',
