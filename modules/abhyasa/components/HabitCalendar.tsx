...
const HabitCalendar: React.FC<HabitCalendarProps> = ({ habit, habitLogs, selectedDate }) => {
    ...
    const getHabitDayStatus = useCallback((date: Date): 'completed' | 'skipped' | 'missed' | 'not-logged' | 'inactive' | 'future' => {
    ...
    const getDayClass = useCallback((date: Date) => {
        ...
        if (date.getTime() === new Date(0).getTime()) { // Placeholder
            return "";
        }
    ...
    return (
        <div className="p-4 bg-gray-50 rounded-lg border">
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-lg font-semibold text-gray-800">{monthName} {currentYear}</span>
